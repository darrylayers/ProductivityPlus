...
/**
 * CheckIdle.java is used to determine if the user is idle
 * and decides if the data being recorded should be recorded 
...
public class CheckIdle implements Runnable {
	...
	/*
	 * This method saves the (x,y) location of the mouse
	 * on the screen.
	 */
	...
	/*
	 * This method checks for mouse movement for the given threshold
	 * by comparing new coord values to old ones.
	 */
	...
	/*
	 * This method checks for keystrokes for the given threshold.
	 */
