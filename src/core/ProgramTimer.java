...
public class ProgramTimer implements Runnable {
	...
	/**
	 * Overridden run method to run the timer on a new thread. Tracks to see when
	 * the user swaps the program in focus and records the time differences.
	 * Operates on a pause set to 1/10 per second.
	 */
	@Override
	public void run() {
		idle = new CheckIdle();
	...
	public static void endTime() {
		...
		System.out.println("Closing session and counted " + newTime + " seconds.");
	}
	...
	public static void printMap() {
		...
		for (String name : appMap.keySet()) {
			...
			if (value > 60) {
				System.out.print(
						"Time spent in " + key + " was " + value / 60 + " minutes and " + value % 60 + " seconds.");
			} else {
				System.out.println("Time spent in " + key + " was " + value + " seconds.");
			}
		}
		System.out.println("=====================\n");
	}
