...
public class ProgramTimer implements Runnable {
    ...
    /*
     *  Method to stop tracking when an old window is in focus. 
     *  Must divide to convert to seconds from nanoseconds.
     */
    ...
    public static void printMap() {
        ...
        for (String name : appMap.keySet()) {
            ...
            if (value > 60) {
                System.out.print("Time spent in " + key + " was " + value / 60
