...
public class TestProgramTimer {
     ...
     * 
     * This method tests ProgramTimer.java by launching four dummy JFrame
     * windows for 0 seconds then tests to see if the timer recorded the window
     * being open for the proper amount of time.
     * 
     * public void testFourApps0Secs() throws InterruptedException {
     * 
     * // Start the timer ProgramTimer programTimer = new ProgramTimer(); Thread
     * t = new Thread(programTimer); t.start();
     * 
     * int time = 500;
     * 
     * // Create dummy window 1 String window_name = "Window1_0sec " + time /
     * 1000 + " seconds"; CreateDummyWindow window = new
     * CreateDummyWindow(window_name); Thread.sleep(time);
     * window.frame.dispose(); Thread.sleep(100); assertEquals(time / 1000,
     * programTimer.appMap.get(window_name).longValue());
     * 
     * programTimer.printMap(); // Dummy window 2
     * 
     * window_name = "Window2_0sec " + time / 1000 + " seconds"; window = new
     * CreateDummyWindow(window_name); Thread.sleep(time);
     * window.frame.dispose(); Thread.sleep(100); assertEquals(time / 1000,
     * programTimer.appMap.get(window_name).longValue());
     * 
     * programTimer.printMap(); // Dummy window 3
     * 
     * window_name = "Window3_0sec " + time / 1000 + " seconds"; window = new
     * CreateDummyWindow(window_name); Thread.sleep(time);
     * window.frame.dispose(); Thread.sleep(100); assertEquals(time / 1000,
     * programTimer.appMap.get(window_name).longValue());
     * 
     * programTimer.printMap(); // Dummy window 4
     * 
     * window_name = "Window4_0sec " + time / 1000 + " seconds"; window = new
     * CreateDummyWindow(window_name); Thread.sleep(time);
     * window.frame.dispose(); Thread.sleep(100); assertEquals(time / 1000,
     * programTimer.appMap.get(window_name).longValue());
     * 
     ...
     * 
     * This method tests ProgramTimer.java by launching four dummy JFrame
     * windows for 1 second then tests to see if the timer recorded the window
     * being open for the proper amount of time.
     * 
     ...
     * int time = 1000;
     * 
     * // Create dummy window 1 String window_name = "Window1_1sec " + time /
     * 1000 + " seconds"; CreateDummyWindow window = new
     * CreateDummyWindow(window_name); Thread.sleep(time);
     * window.frame.dispose(); Thread.sleep(100); assertEquals(time / 1000,
     * programTimer.appMap.get(window_name).longValue());
     ...
     * programTimer.printMap(); // Dummy window 2
     * 
     * window_name = "Window2_1sec " + time / 1000 + " seconds"; window = new
     * CreateDummyWindow(window_name); Thread.sleep(time);
     * window.frame.dispose(); Thread.sleep(100); assertEquals(time / 1000,
     * programTimer.appMap.get(window_name).longValue());
     * 
     * programTimer.printMap(); // Dummy window 3
     * 
     * window_name = "Window3_1sec " + time / 1000 + " seconds"; window = new
     * CreateDummyWindow(window_name); Thread.sleep(time);
     * window.frame.dispose(); Thread.sleep(100); assertEquals(time / 1000,
     * programTimer.appMap.get(window_name).longValue());
     * 
     * programTimer.printMap(); // Dummy window 4
     * 
     * window_name = "Window4_1sec " + time / 1000 + " seconds"; window = new
     * CreateDummyWindow(window_name); Thread.sleep(time);
     * window.frame.dispose(); Thread.sleep(100); assertEquals(time / 1000,
     * programTimer.appMap.get(window_name).longValue());
     * 
